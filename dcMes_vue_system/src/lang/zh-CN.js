...
export default {
  ...
  scanBarCodeBatch: {
    ...
    messages: {
      ...
      saveSuccess: '保存成功',
      saveFailed: '保存失败',
      cancelSettingsConfirm: '确认取消当前工序设置？这将清除所有批次物料和打印模板的缓存数据。',
  ...
  scanBarCodeConver: {
    ...
    messages: {
      ...
      saveSuccess: '保存成功',
      saveFailed: '保存失败',
      cancelSettingsConfirm: '确认取消当前工序设置？这将清除所有批次物料的缓存数据。',
      settingsCancelled: '已取消工序设置',
      cancelSettingsFailed: '取消设置失败',
      // 扫描相关消息
      scanSuccess: '扫描成功',
  ...
  scanBarCodeRepair: {
    ...
    messages: {
      ...
      // 批次相关消息
      batchUsageLimitReached: '批次物料条码已达到使用次数限制',
      batchUsageLimitReachedWithCount: '批次物料条码 {barcode} 已达到使用次数限制 {count}次',
      ...
      deviceNotConnected: '设备未连接',
      // 确认对话框消息
      confirmCancelSettings: '确认取消当前工序设置？这将清除所有批次物料的缓存数据。',
      confirmClearCache: '确认清除所有页面缓存数据？此操作不可恢复。'
    },
    dialogs: {
      hint: '提示',
  ...
  productRepair: {
    ...
    messages: {
      ...
      selectedRecordsContainInvalid: '选中记录中包含已审核或已作废的记录，不能进行批量审核',
      // 操作成功消息
      voidSuccess: '作废成功',
      batchVoidSuccess: '批量作废成功',
      reviewSuccess: '审核成功',
      scrapReviewSuccess: '报废审核成功',
      batchReviewSuccessTemplate: '批量审核成功，共处理 {updatedCount} 条记录，其中报废 {scrapCount} 条',
      // 操作失败消息
      operationFailed: '操作失败',
      reviewFailed: '审核失败',
  ...
  editDialog: {
    ...
    tips: {
      ...
      componentReplacementContent: '选择部件更换方案时，请确保已准备好相应的替换部件，并记录更换的部件信息。'
    },
    messages: {
