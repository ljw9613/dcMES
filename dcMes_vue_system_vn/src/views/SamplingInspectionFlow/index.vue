<template>
    <div class="app-container">
        ...
        <el-dialog title="扫码抽检" :visible.sync="scanDialogVisible" width="500px" :close-on-click-modal="false">
            <el-form :model="scanForm" ref="scanForm" :rules="scanRules" label-width="100px">
                <el-form-item label="产品条码" prop="barcode">
                    <el-input v-model="scanForm.barcode" placeholder="请扫描或输入产品条码" ref="barcodeInput" @keyup.enter.native="handleBarcodeEnter"></el-input>
                </el-form-item>
                <div v-if="showQualityCheck">
                    <el-form-item label="物料编码">
                        <el-input v-model="currentFlowData.materialCode" readonly></el-input>
                    </el-form-item>
                    <el-form-item label="产品名称">
                        <el-input v-model="currentFlowData.materialName" readonly></el-input>
                    </el-form-item>
                    <el-form-item label="产品型号">
                        <el-input v-model="currentFlowData.materialSpec" readonly></el-input>
                    </el-form-item>
                ...
                <el-form-item label="检验结果" prop="isQualified" v-if="showQualityCheck">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="handleScanConfirm" :loading="scanLoading" v-if="showQualityCheck">确 定</el-button>
            </div>
        </el-dialog>
    ...
    methods: {
        ...
        async handleBarcodeSearch() {
            ...
            try {
                ...
                const mainBarcodeResult = await getData('sampling_nspection_flow', searchQuery);
                ...
                const currentBarcodeResult = await getData('sampling_nspection_flow', currentSearchQuery);
            ...
            try {
                this.$refs.scanForm.validate(async (valid) => {
                    if (valid) {
                        ...
                        // 保存抽检记录
                        const result = await addData('sampling_nspection_flow', inspectionData);
