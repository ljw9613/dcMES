...
export default {
  ...
  scanBarCode: {
    ...
    messages: {
      ...
      barcodeFormatError: 'Định dạng mã vạch không đúng, chưa được đăng ký trong hệ thống',
      duplicateBarcode: 'Mã vạch này đã được sử dụng, vui lòng xác nhận có phải quét trùng lặp',
      flowRecordCreated: 'Tạo bản ghi truy xuất mã vạch thành phẩm thành công',
      flowRecordCreateFailed: 'Tạo bản ghi truy xuất mã vạch thành phẩm thất bại',
      pleaseInitializeProcess: 'Vui lòng khởi tạo cài đặt quy trình trước, chọn quy trình ràng buộc hoặc quy trình kiểm tra'
    },
    ...
    scanning: {
      ...
      modeTooltip: 'Chế độ thường dùng để quét mã vạch, chế độ RFID dùng để đọc thẻ RFID'
    },
  ...
  scanBarCodeBatch: {
    ...
    initTip: {
      message: 'Vui lòng khởi tạo cài đặt quy trình trước, kiểm tra xem quy trình hiện tại có phải là quy trình pallet không'
    },
    messages: {
      ...
      // 保存和取消消息
      pleaseSelectProductProcessLine: 'Vui lòng chọn mẫu sản phẩm, quy trình và dây chuyền sản xuất',
      saveSuccess: 'Lưu thành công',
      saveFailed: 'Lưu thất bại',
      cancelSettingsConfirm: 'Xác nhận hủy cài đặt quy trình hiện tại? Điều này sẽ xóa tất cả dữ liệu cache vật liệu lô và mẫu in.',
      ...
      barcodeFormatIncorrect: 'Định dạng mã vạch không chính xác, chưa đăng ký trong hệ thống',
      materialMismatch: 'Vật liệu tương ứng với mã vạch không khớp với vật liệu cần thiết cho quy trình hiện tại',
      hasUnfinishedRepairRecord: 'Mã vạch này có bản ghi sửa chữa chưa hoàn thành',
      hasCompletedScrapProcessing: 'Mã vạch này đã hoàn thành xử lý phế liệu',
      repairResultUnqualified: 'Mã vạch này đã hoàn thành sửa chữa, nhưng kết quả sửa chữa không đạt yêu cầu'
    }
  },
  ...
  scanBarCodeBatchNew: {
    ...
    messages: {
      ...
      barcodeValidationFailed: 'Xác thực mã vạch thất bại',
      barcodeFormatIncorrect: 'Định dạng mã vạch không chính xác, chưa đăng ký trong hệ thống',
      barcodeNotMatchAnyMaterial: 'Mã vạch không khớp với bất kỳ vật liệu nào cần thiết',
      flowRecordCreateSuccess: 'Tạo bản ghi truy xuất mã vạch thành phẩm thành công',
      // 系统错误消息
      ...
      barcodeRuleNotFound: 'Không tìm thấy quy tắc mã vạch khả dụng (bao gồm quy tắc sản phẩm cụ thể và quy tắc toàn cục)',
      barcodeRuleNotMatch: 'Mã vạch này không phù hợp với bất kỳ quy tắc nào đã cấu hình hoặc vật liệu không khớp',
      ...
      repairResultUnqualified: 'Mã vạch này đã hoàn thành sửa chữa, nhưng kết quả sửa chữa không đạt',
      // 托盘解绑消息
      palletUnbindRecord: 'Mã vạch này có bản ghi hủy ràng buộc pallet, vui lòng xử lý tại bàn sửa chữa',
      // 包装箱相关消息
      processingBoxBarcode: 'Đang xử lý mã vạch thùng đóng gói, vui lòng đợi xử lý hoàn tất...',
      printTemplateRequired: 'Vui lòng chọn mẫu in trước',
      boxProcessRequired: 'Quy trình hiện tại bao gồm công đoạn đóng thùng, phải quét mã vạch thùng đóng gói.',
      boxQuantityExceedsLimit: 'Số lượng mã vạch trong thùng đóng gói vượt quá số lượng khả dụng còn lại của pallet',
      boxScanSuccess: 'Quét thùng đóng gói thành công, thêm mã vạch',
      scanProcessingFailed: 'Xử lý quét thất bại',
      // 批次相关消息
      batchUsageLimitReached: 'Mã vạch vật liệu lô đã đạt giới hạn số lần sử dụng',
      batchQuantityCannotBeLess: 'Số lượng lô không thể nhỏ hơn số lượng đã vào pallet',
      ...
      noActiveWorkOrder: 'Dây chuyền hiện tại không có lệnh sản xuất đang hoạt động',
      workOrderChanged: 'Phát hiện lệnh sản xuất đã thay đổi, cache vật liệu lô đã được xóa',
      // 打印相关消息
      ...
      pleaseInitializeProcess: 'Vui lòng khởi tạo cài đặt quy trình quét lô trước',
      // 测试消息
      palletAutoModeSwitch: 'Chuyển đổi chế độ thủ công/tự động đóng gói pallet',
  ...
  scanBarCodeConver: {
    ...
    messages: {
      ...
      saveSuccess: 'Lưu thành công',
      saveFailed: 'Lưu thất bại',
      cancelSettingsConfirm: 'Xác nhận hủy cài đặt quy trình hiện tại? Điều này sẽ xóa tất cả dữ liệu cache vật liệu lô.',
      settingsCancelled: 'Đã hủy cài đặt quy trình',
      cancelSettingsFailed: 'Hủy cài đặt thất bại',
      // 扫描相关消息
      scanSuccess: 'Quét thành công',
      ...
      clearCacheFailed: 'Xóa cache thất bại',
      confirmCompleteAllScanning: 'Vui lòng hoàn thành tất cả việc quét mã vạch cần thiết',
      conversionSuccess: 'Chuyển đổi thành công',
      conversionFailed: 'Chuyển đổi thất bại',
      pleaseInitializeProcess: 'Vui lòng khởi tạo cài đặt quy trình chuyển đổi trước',
      // 系统错误消息
      getBarcodeRulesFailed: 'Lấy quy tắc mã vạch thất bại',
      getProductModelFailed: 'Lấy mẫu sản phẩm thất bại',
      getProcessStepsFailed: 'Lấy danh sách quy trình thất bại',
  ...
  scanBarCodePack: {
    ...
    initTip: {
      message: 'Vui lòng khởi tạo cài đặt quy trình trước, chọn quy trình không phải pallet'
    },
    buttons: {
      reset: 'Đặt lại',
      confirm: 'Xác nhận',
    ...
    messages: {
      ...
      repairResultUnqualified: 'Mã vạch này đã hoàn thành sửa chữa, nhưng kết quả sửa chữa không đạt',
      // 包装相关消息
      useMainBarcodeInOrder: 'Vui lòng sử dụng mã vạch vật liệu chính theo thứ tự, nên sử dụng mã vạch',
      batchUsageLimitReached: 'Số lần sử dụng mã vạch lô đã đạt giới hạn',
      batchUsageLimitReachedWithCode: 'Mã vạch vật liệu lô đã đạt giới hạn số lần sử dụng',
      confirmCompleteAllScanning: 'Vui lòng hoàn thành tất cả việc quét mã vạch cần thiết',
      confirmFailedPrefix: 'Xác nhận thất bại',
      // 设备连接消息
      deviceServerConnected: 'Kết nối máy chủ thiết bị thành công',
      ...
      clearCacheFailed: 'Xóa cache thất bại',
      // 包装箱相关消息
      materialNotBoundBarcodeRule: 'Vật liệu này chưa ràng buộc quy tắc tạo mã vạch',
      ...
      pleaseInitializeProcess: 'Vui lòng khởi tạo cài đặt quy trình trước, chọn quy trình không phải pallet'
    }
  },
  ...
  scanBarCodeRepair: {
    ...
    scanning: {
      ...
      scanPlaceholder: 'Vui lòng quét mã vạch',
      scanMainBarcodePlaceholder: 'Vui lòng quét mã vạch vật liệu chính cần sửa chữa',
      scanSubBarcodePlaceholder: 'Vui lòng quét mã vạch vật liệu phụ',
      conversion: 'Chuyển đổi',
      normal: 'Bình thường'
    },
    ...
    initTip: {
      message: 'Vui lòng thiết lập quy trình sửa chữa trước, chọn quy trình ràng buộc hoặc quy trình kiểm tra'
    },
    messages: {
      // 模式切换消息
      autoInitEnabled: 'Đã bật chế độ khởi tạo tự động',
      ...
      keyMaterialRequireMainBarcode: 'Vật liệu quan trọng phải quét mã vạch chính trước',
      // 批次相关消息
      batchUsageLimitReached: 'Mã vạch vật liệu lô đã đạt giới hạn số lần sử dụng',
      batchUsageLimitReachedWithCount: 'Mã vạch vật liệu lô {barcode} đã đạt giới hạn số lần sử dụng {count} lần',
      batchCodeUsageLimitReached: 'Mã vạch lô đã đạt giới hạn số lần sử dụng',
      // 确认相关消息
      pleaseCompleteAllScans: 'Vui lòng hoàn thành tất cả việc quét mã vạch cần thiết',
      confirmFailed: 'Xác nhận thất bại',
      workOrderNotFound: 'Không tìm thấy lệnh sản xuất',
      processNodeCompleted: 'Nút quy trình tương ứng với mã vạch vật liệu chính này đã hoàn thành hoặc ở trạng thái bất thường',
      // 打印相关消息
      ...
      // 设备连接消息
      deviceServerConnected: 'Kết nối máy chủ thiết bị thành công',
      deviceConnectionLost: 'Kết nối thiết bị đã bị ngắt, {delay} giây sau thử kết nối lại lần thứ {attempts}',
      maxReconnectAttemptsReached: 'Đã đạt giới hạn số lần kết nối lại, vui lòng kiểm tra kết nối mạng hoặc làm mới trang',
      deviceConnectionInitFailed: 'Khởi tạo kết nối thiết bị thất bại',
      deviceNotConnected: 'Thiết bị chưa kết nối',
      ...
      // 确认对话框消息
      confirmCancelSettings: 'Xác nhận hủy cài đặt quy trình hiện tại? Điều này sẽ xóa tất cả dữ liệu cache vật liệu lô.',
      confirmClearCache: 'Xác nhận xóa tất cả dữ liệu cache trang? Thao tác này không thể khôi phục.'
    },
    dialogs: {
      hint: 'Gợi ý',
  ...
  scanBarCodeCheck: {
    ...
    messages: {
      ...
      startVerification: 'Bắt đầu quy trình xác minh dây chuyền, vui lòng quét mã QR'
    }
  },
  ...
  productRepair: {
    ...
    messages: {
      ...
      deleteSuccess: 'Xóa thành công',
      deleteFailed: 'Xóa thất bại',
      deleteConfirm: 'Thao tác này sẽ xóa vĩnh viễn bản ghi, có tiếp tục không?',
      ...
      selectedRecordsContainReviewed: 'Các bản ghi đã chọn có chứa bản ghi đã duyệt, không thể xóa',
      pleaseSelectRecordsToReview: 'Vui lòng chọn bản ghi cần duyệt',
      selectedRecordsContainInvalid: 'Các bản ghi đã chọn có chứa bản ghi đã duyệt hoặc đã hủy, không thể duyệt hàng loạt',
      // 操作成功消息
      ...
      batchReviewSuccessTemplate: 'Duyệt hàng loạt thành công, đã xử lý {updatedCount} bản ghi, trong đó phế liệu {scrapCount} bản ghi',
      // 操作失败消息
      operationFailed: 'Thao tác thất bại',
      ...
      nonScrapRecordsNeedResult: 'Bản ghi sửa chữa không phải phế liệu cần chọn kết quả sửa chữa',
      // 产品详情消息
  ...
  editDialog: {
    ...
    tips: {
      ...
      componentReplacementContent: 'Khi chọn phương án thay thế linh kiện, vui lòng đảm bảo đã chuẩn bị sẵn linh kiện thay thế tương ứng và ghi lại thông tin linh kiện được thay thế.'
    },
    messages: {
  ...
  statusPopup: {
    ...
    errorMessages: {
      ...
      'materialNotRequired': 'Vật liệu không thuộc về vật liệu yêu cầu quét của quy trình hiện tại',
      ...
      'craftInfoNotFound': 'Không tìm thấy thông tin công nghệ tương ứng với vật liệu',
      'barcodeParameterEmpty': 'Tham số mã vạch không được để trống',
      'productionPlanNotFound': 'Công nghệ thành phẩm không tìm thấy kế hoạch dây chuyền',
      ...
      'workOrderMismatch': 'Lệnh sản xuất dây chuyền hiện tại không nhất quán với lệnh sản xuất mã vạch sản phẩm',
      ...
      'repairRecordNotFound': 'Không tìm thấy bản ghi sửa chữa thay thế bộ phận tương ứng',
