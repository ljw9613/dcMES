    ...
    <div class="app-container">
        ...
        <el-card class="search-container">
            <div class="search-area">
                <el-input v-model="searchBarcode" placeholder="请输入条码" clearable @keyup.enter.native="handleSearch">
        ...
        async handleSearch() {
            ...
            try {
                ...
                if (result.code === 200 && result.data && result.data.length > 0) {
                    ...
                    const currentResult = await getData('material_process_flow', currentQuery);
                    if (currentResult.code === 200 && currentResult.data && currentResult.data.length > 0) {
