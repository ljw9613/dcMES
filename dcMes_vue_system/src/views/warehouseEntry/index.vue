<template>
    <div class="app-container">
        <el-card class="filter-container">
            ...
            <el-form :model="searchForm" ref="searchForm" class="demo-form-inline">
                ...
                <el-form-item>
                    ...
                    <!-- 扫码入库 -->
                    <el-button type="primary" @click="handlePalletBarcodeOpen">扫描单据入库</el-button>
                </el-form-item>
            </el-form>
        </el-card>
        ...
        <!-- 新增/编辑对话框 -->
        <el-dialog :title="dialogStatus === 'create' ? '新增入库单' : '查看入库单'" :visible.sync="dialogFormVisible">
        ...
        <!-- 使用通用扫描弹窗 -->
        <scan-dialog :visible.sync="scanDialogVisible" title="托盘扫码入库" placeholder="请扫描托盘条码" @scan="handleScan"
